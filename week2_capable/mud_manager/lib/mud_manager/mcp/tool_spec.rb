  ...
  module Mcp
    ...
    module ToolSpec
      ...
      TOOLS = [
        ...
        Tool.new(
          name: "inspect",
          description: "Look at the room and list its exits (with destination room names) in " \
                       "one call. Use this in a new room instead of looking and checking exits " \
                       "separately.",
          params: {}, dispatch: :inspect
        ),
        Tool.new(
          name: "poll",

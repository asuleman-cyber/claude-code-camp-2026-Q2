...
module MudMonitor
  ...
  # doc's Rails+React design to Sinatra+ERB (see week3_capable/README.md
  # Phase B) and to "live polling" (meta-refresh) rather than SSE.
  class App < Sinatra::Base
    set :root, File.expand_path("../..", __dir__)
    # __dir__ is .../week3_capable/mud_monitor/lib/mud_monitor — four levels
    # up reaches the repo root: lib/mud_monitor -> lib -> mud_monitor ->
    # week3_capable -> repo root.

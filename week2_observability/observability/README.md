...
```sh
docker compose -f week2_observability/observability/docker-compose.yml --profile debug up
docker compose -f week2_observability/observability/docker-compose.yml --profile jaeger up
docker compose -f week2_observability/observability/docker-compose.yml --profile tempo up
docker compose -f week2_observability/observability/docker-compose.yml --profile compare up
```

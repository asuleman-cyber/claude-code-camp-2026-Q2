...
**The Beginning Of The Passage** (north of The Entrance To The Newbie
Zone — i.e. one step *inside* the newbie zone proper)
- Exits: e (unexplored), s (back to the Entrance)
- Notes: "a long corridor... you can hear the sound of creatures roaming
  about." A newbie monster stands here. Character was here at the start
  of the 2026-07-20 session (unclear why — last session ended at The
  Levee, so position doesn't reliably persist between logins). Not
  fought/explored further this session; east is unexplored.
...
**Main Street (west end)** — one room further west of the Main Street
room above (Market Square -w-> Main Street -w-> here).
- Exits: n, e, s, w
- Notes: the magic shop is to the north (unexplored), city gate to the
  west (unexplored), **Guild of Magic Users entrance to the south** —
  see below. Beastly fidos and a janitor wander through here too.

**The Entrance To The Mages' Guild** (south of Main Street's west end)
- Exits: n, s
- NPCs: **a sorcerer** guarding the entrance (guildmaster/trainer,
  presumed).
- Notes: ATM here too. South leads further into the guild (unexplored
...
### Poor Alley / south side (west and south of Common Square)

**The Eastern End Of Poor Alley** (west of Common Square)
- Exits: e, s, w
- NPCs: **the Mayor** (wanders, greets citizens), **a Peacekeeper**
  (guard), beastly fidos.
- Notes: Grubby Inn to the south (unexplored). Alley continues west.

**Poor Alley** (west of the above — dead-end-ish)
- Exits: e, w
- NPCs: **a beggar**.
- Notes: city wall to the west; no further exits (n/s both blocked here).

**The Dump** (south of Common Square — the "nasty smell")
- Exits: n, d
- Notes: entrance to the sewer system visible through the garbage
  (down, unexplored).
...
- **Guildmaster / practice trainer** — Guild of Magic Users found (see City
  center, Main Street west end -> south), guarded by a sorcerer; Clerics'
  Guild at Temple Square and Guild of Thieves south of Dark Alley also
  located but interiors unexplored. Warrior guild still not located.
